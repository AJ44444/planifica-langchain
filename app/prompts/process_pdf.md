...
2. **Career & Grade Association (Ciclo Básico & Multi-grade)**
   - For **Ciclo Básico** curricula (e.g. Mathematics containing 1st, 2nd, and 3rd grade sections), **each grade is treated as its own distinct career name** (e.g. *Primero Básico*, *Segundo Básico*, *Tercero Básico*).
   - Each grade section MUST be saved under its corresponding grade/career name (`nombre_carrera`) so that the subarea competency tree is associated with the correct area and grade scope.

3. **Grade Identification & Area Structuring**
