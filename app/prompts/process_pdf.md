...
2. **Grade Identification & Structuring**
   ...
   - **Curricular Area**: Area name, suggested activities, and evaluation criteria.
...
3. **Structure Flattening**
   - Flattens each area structure into: `actividades_sugeridas`, `criterios_evaluacion_sugeridos`, and `subareas`.
