...
Solicita el árbol curricular de la subárea seleccionada, recibe la respuesta y construye la planificación utilizando únicamente el árbol curricular, guarda la planificación en el sistema.
